...
private void addOrder(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    System.out.println("servlet.OrderServlet.addOrder()------- " + address + total + quantity + date);
    OrderDao orderDao = new OrderDao();
    System.out.println("run at here 001");
    orderDao.addOrder(new Order(user_id, address, total, quantity, date));
  System.out.println("run at here 002");
    listOrders(request, response);
}
